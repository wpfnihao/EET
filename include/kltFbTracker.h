...
public:
	 ...
	 */
	void measurePose(std::vector<vpPoint>& stableFeatures3d, std::vector<cv::Point2f>& stableFeatures2d);
	...
	inline vpMbtPolygon* getPolygon(void)
	{
		return pyg;
	}
// utility functions
protected:
	 ...
	 * @param fStatus
	 * @param bStatus
	 * @param stableFeatures3d
	 * @param stableFeatures2d
	 * @param th
	 */
